(defproject markbastian/partsbin "0.1.3-SNAPSHOT"
  ...
  :managed-dependencies [[args4j "2.33"]
                         [clj-time "0.15.2"]
                         [commons-codec "1.14"]
                         ...
                         [com.google.javascript/closure-compiler-externs "v20200224"]
                         [com.google.javascript/closure-compiler-unshaded "v20200224"]
  ...
  :dependencies [[org.clojure/clojure "1.10.1"]
                 [integrant "0.8.0"]
                 [com.taoensso/timbre "4.10.0"]
                 [datascript "0.18.10" :scope "provided"]
                 [etaoin "0.3.6" :scope "provided"]
                 [hawk "0.2.11" :scope "provided"]
                 [hikari-cp "2.10.0" :scope "provided"]
                 ...
                 [seancorfield/next.jdbc "1.0.395" :scope "provided"]]
